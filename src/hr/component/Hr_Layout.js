...
import { MenuFoldOutlined, MenuUnfoldOutlined, ScheduleOutlined, AppstoreOutlined, UsergroupAddOutlined, TeamOutlined, ProjectOutlined, SolutionOutlined, LogoutOutlined, HarmonyOSOutlined, AuditOutlined } from '@ant-design/icons';
...
const MainLayout = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserDetails = async () => {
      try {
        const response = await axios.get('http://77.37.45.224:8000/api/user/getAllEmployee', {
          headers: {
