...
//           style={{
//             padding: "8px 16px",
//             backgroundColor: isExperienced ? "#4CAF50" : "#f44336",
//             color: "#fff",
//             border: "none",
//             borderRadius: "4px",
//             cursor: "pointer",
...
//       <label style={{ marginRight: "16px" }}>Highest Qualification:</label>
//       <select
//         style={{ width: "27%", marginBottom: "16px" }}
//         name="HighestQualification"
//         value={formData.HighestQualification}
//         onChange={handleInputChange}
//       >
...
//       <label style={{ marginRight: "72px", marginLeft: "-30px" }}>Passout Year:</label>
//       <select
//         style={{ width: "26%", marginBottom: "16px" }}
//         name="Year"
//         value={formData.Year}
//         onChange={handleInputChange}
//       >
...
//               onChange={handleInputChange}
//             />
//             <label style={{ marginRight: "16px", marginLeft: "16px" }}>
//               Last Company Name:
//             </label>
//             <input
//               style={{ width: "26%" }}
...
//               onChange={handleInputChange}
//             />
//             <label style={{ marginRight: "56px", marginLeft: "16px" }}>
//               Relieving Date:
//             </label>
//             <input
//               type="date"
