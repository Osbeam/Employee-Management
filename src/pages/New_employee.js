  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3004/api/employee/register",
        formdata
      );
        ...
        <form className="new-emp-form" onSubmit={handleSubmit}>
          <div className="form-container">
            ...
            <div className="inner-container">
              ...
              <input style={{ width: "62%" }} placeholder="Permanent address" />
              <br />
              <input
                style={{ marginLeft: "137px", width: "62%" }}
            ...
            <div className="inner-container">
              ...
              <label style={{ marginRight: "113px", marginLeft: "-28px" }}>
                Year :
              </label>
              ...
              <input style={{ width: "26%" }} placeholder="Last Company Name" />
              <br />
            ...
            <div className="inner-container">
              ...
              <input style={{ width: "26%" }} placeholder="Relation" />
              <br />
              ...
              <input style={{ width: "26%" }} placeholder="Address" />
              <br />
            ...
            <div className="inner-container">
              ...
              <div className="grid-container">
                ...
                <div className="grid-item6">
                  <input type="text" id="basicSalaryPerMonth" />
                </div>
                ...
                <div className="grid-item9">
                  <input type="text" id="FixedAllowancePerMonth" />
                </div>
                ...
                <div className="grid-item12">
                  <input type="text" id="specialallowncePerMonth" />
                </div>
                ...
                <div className="grid-item15">
                  <input type="text" id="variableAllowancePerMonth" />
                </div>
      ...
      <TabPane tab="Assets" key="3">
        <div className="form-container">
          <div className="inner-container">
            ...
            <label for="yes" style={{ fontSize: "18px" }}>
              Yes
            </label>
            <input
              ...
              value="yes"
            />
            <label for="no" style={{ fontSize: "18px" }}>
              No
            </label>
