...
export default function CpApp() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('http://localhost:5005/api/user/getAllUsers');
    ...
    useEffect(()=>{
        const fetchLoanData = async ()=>{
            try {
                const response = await axios.get('http://localhost:5005/api/loanForm/getAllLoanForms');
