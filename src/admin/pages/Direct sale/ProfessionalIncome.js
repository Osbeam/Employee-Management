...
const ProfessionalIncome = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            let found = false;    // Flag to stop the loop when the user is found
            setLoading(true);

            try {
                while (!found) {
                    const response = await axios.get(`http://77.37.45.224:8000/api/bussinessIncome/getAllBusinessIncome`, {
                        params: { currentPage }
                    });
                    ...
                    if (response.data.success && response.data.data.length > 0) {
                        ...
                        if (userData && userData.professionalIncome) {
                            setData(userData.professionalIncome);
                            console.log(userData.professionalIncome);
                            found = true;  // Stop further page fetching
                        } else if (response.data.data.length < 10) {
                            // Assuming less than 10 records means it's the last page
                            setError('Professional Income not found for this user.');
                            break;  // Stop if no more pages left
                        }
                    } else {
                        setError('Data retrieval unsuccessful.');
                        break;  // Stop on error or no data
                    }

                    currentPage++;  // Move to the next page if user not found
                }
            } catch (err) {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch('http://77.37.45.224:8000/api/professionalIncome/EditProfessionalIncomesData', {
                method: 'PUT',
                headers: {
                ...
                <Tabs ref={tabsRef} activeKey={activeKey} onChange={setActiveKey}>
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Name of the Profession" className="FormItem">
                                        <Input
                                            name="ProfessionName"
                                            value={data?.ProfessionName || ''}
                                            onChange={(e) => handleInputs('ProfessionName', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                                <Col span={12}>
                                    <Form.Item label="Type of Profession" className="FormItem">
                                        <Input
                                            ...
                                            onChange={(e) => handleInputs('TypeOfProfession', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                                ...
                                <Col span={12}>
                                    <Form.Item label="Profession Formation Type" className="FormItem">
                                        <Input
                                            ...
                                            onChange={(e) => handleInputs('ProfessionFormationType', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                                <Col span={12}>
                                    <Form.Item label="Profession Formation Date" className="FormItem">
                                        <Input
                                            ...
                                            onChange={(e) => handleInputs('ProfessionFormationDate', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                                ...
                                <Col span={12}>
                                    <Form.Item label="Office Location" className="FormItem">
                                        <Input
                                            ...
                                            onChange={(e) => handleInputs('OfficeLocation', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                                            ...
                                            <Col span={8}>
                                                <Form.Item label="Filling Date">
                                                    <Input
                                                        ...
                                                        onChange={(e) => handleYearWiseITRChange(index, 'FillingDate', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </Col>
                                            <Col span={8}>
                                                <Form.Item label="Profit">
                                                    <Input
                                                        placeholder="Profit"
                                                        value={item.Profit}
                                                        onChange={(e) => handleYearWiseITRChange(index, 'Profit', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </Col>
                                            <Col span={8}>
                                                <Form.Item label="Turn Over">
                                                    <Input
                                                        ...
                                                        value={item.TurnOver}
                                                        onChange={(e) => handleYearWiseITRChange(index, 'TurnOver', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </Col>
                                        </Row>
                            ...
                            <Row gutter={[8, 8]}>
                                ...
                                <Col span={12}>
                                    <Form.Item label=" Certificate of practice number  " className="FormItem">
                                        <Input value={data?.CertificateOfPracticeNumber || ''}
                                            name="CertificateOfPracticeNumber"
                                            onChange={(e) => handleInputs('CertificateOfPracticeNumber', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Date of  Certificate of practice number" className="FormItem">
                                        <Input value={data?.DateOfCertificateOfPracticeNumber || ''}
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Date of Registration" className="FormItem">
                                        <Input value={data?.DateOfGstRegistration || ''}
                            ...
                            <Row gutter={[8, 8]}>
                                ...
                                <Col span={12}>
                                    <Form.Item label=" Shop Act License Number" className="FormItem">
                                        <Input value={data?.ShopActLicenceNumber || ''}
                                            name="ShopActLicenceNumber"
                                            onChange={(e) => handleInputs('ShopActLicenceNumber', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Date of Shop Act License Number" className="FormItem">
                                        <Input value={data?.DateOfShopActLicenceNumber || ''}
                                            name="DateOfShopActLicenceNumber"
                                            type="Date"
                                            onChange={(e) => handleInputs('DateOfShopActLicenceNumber', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                            ...
                            <Row gutter={[8, 8]}>
                                ...
                                <Col span={12}>
                                    <Form.Item label=" Aadhaar Udhyog Number" className="FormItem">
                                        <Input value={data?.AadharUdhyogNumber || ''}
                                            name="AadharUdhyogNumber"
                                            onChange={(e) => handleInputs('AadharUdhyogNumber', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            </Row>
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Date of Aadhaar Udhyog Number " className="FormItem">
                                        <Input value={data?.DateOfAadharUdhyogNumber || ''}
                                            name="DateOfAadharUdhyogNumber"
                                            type="Date"
                                            onChange={(e) => handleInputs('DateOfAadharUdhyogNumber', e.target.value)}
                                        />
                                    </Form.Item>
                                </Col>
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Date of Opening" className="FormItem">
                                        <Input value={data?.DateOfOpening || ''}
                                            name="DateOfOpening"
                                            type="Date"
                    ...
                    <TabPane style={{marginTop:'50px'}}  tab="Professional Income Form 2" key="2">
                        <Form layout="vertical">
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Sourcing Channel" className="FormItem">
                                        <Input value={data?.SourcingChanel || ''}
                                            name="SourcingChanel"
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Residence Type" className="FormItem">
                                        <Input value={data?.ResidenceType || ''}
                                            name="ResidenceType"
                                ...
                                <Col span={12}>
                                    <Form.Item label="Residence City" className="FormItem">
                                        <Input value={data?.ResidenceCity || ''}
                                            name="ResidenceCity"
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={24}>
                                    <Form.Item label="Permanent Address" className="FormItemAdd" >
                                        ...
                                        <Input value={data?.PermanentAddress || ''}
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Organization Name" className="FormItem">
                                        <Input value={data?.OrganizationName || ''}
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Formation Type" className="FormItem">
                                        <Input value={data?.FormationType || ''}
                                            name="FormationType"
                            ...
                            <Row gutter={[8, 8]}>
                                ...
                                <Col span={12}>
                                    <Form.Item label="Current Experience" className="FormItem">
                                        <Input value={data?.CurrentExperience || ''}
                            ...
                            <Row gutter={[8, 8]}>
                                <Col span={12}>
                                    <Form.Item label="Experience Proof" className="FormItem">
                                        <Input value={data?.ExperienceProof || ''}
                                        ...
                                        <tr key={index}>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'AssesmentYear', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'GrossIncome', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'NetIncome', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'OtherIncome', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'TotalIncome', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'PaymentMode', e.target.value)}
                                                />
                                            </td>
                                            <td>
                                                <Input
                                                    ...
                                                    onChange={(e) => handleIncomeDetailsChange(index, 'DateOfFilling', e.target.value)}
                                                />
                                            </td>
                                        </tr>
                                    ))}
                            ...
                            <table style={{ marginTop: '35px', width: '100%', borderCollapse: 'collapse' }}>
                                <thead>
                                    <tr>
                                        <th>Turnover</th>
                                        <th>ITR</th>
                                            ...
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="Turn Over"
                                                        value={item.TurnOver}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'TurnOver', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="ITR"
                                                        value={item.ITR}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'ITR', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="GST"
                                                        value={item.GST}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'GST', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="Banking"
                                                        value={item.Banking}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'Banking', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="Export"
                                                        value={item.Export}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'Export', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="Other"
                                                        value={item.Other}
                                                        onChange={(e) => handleTurnOverDetailsChange(index, 'Other', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                        </tr>
                            ...
                            <table style={{ marginTop: '35px', width: '100%', borderCollapse: 'collapse' }}>
                                <thead>
                                    <tr>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>ABB</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>DR-1</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>DR-2</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>DR-3</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>DR-4</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>DR-5</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="ABB"
                                                        value={item.ABB}
                                                        onChange={(e) => handleBankDetailsChange(index, 'ABB', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="DR-1"
                                                        value={item.DR1}
                                                        onChange={(e) => handleBankDetailsChange(index, 'DR1', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="DR-2"
                                                        value={item.DR2}
                                                        onChange={(e) => handleBankDetailsChange(index, 'DR2', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="DR-3"
                                                        value={item.DR3}
                                                        onChange={(e) => handleBankDetailsChange(index, 'DR3', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="DR-4"
                                                        value={item.DR4}
                                                        onChange={(e) => handleBankDetailsChange(index, 'DR4', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                            <td style={{ padding: '8px', border: '1px solid #ddd' }}>
                                                <Form.Item>
                                                    <Input
                                                        placeholder="DR-5"
                                                        value={item.DR5}
                                                        onChange={(e) => handleBankDetailsChange(index, 'DR5', e.target.value)}
                                                    />
                                                </Form.Item>
                                            </td>
                                        </tr>
