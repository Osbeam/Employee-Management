  ...
  return (
    <Router>
      <Routes>
        ...
        {/* HR Panel Routes */}
        <Route path="/hrpanel/:userId" element={<ProtectedRoute><Hr_Layout /></ProtectedRoute>}>
          ...
          <Route path="/hrpanel/:userId/employee-list/edit-employee-list/:id" element={<Edit_Employee_List />} />
...
//Code before adding params with user id for user profile 
